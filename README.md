...
EVM (Earned Value Management) is a Julia package for forecasting construction costs. 
 ...
 There are four variables that need to be defined prior forecasting. These variables can be used to adjust the shape of the S-curve and smooth out the costs as needed for budget planning:
...
EVM consists of one function, `forecast`, which takes, four arguments: 
